const Footer = () => {
  return (
    <footer className="bg-white mt-20  dark:bg-gray-900">
      <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 w-10/12 mx-auto">
        <div>
      ...
      <div className="py-6 px-4 md:px-12   bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
